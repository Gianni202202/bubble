    ...
    >
      ...
      <div style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        <div className="grid-2" style={{ alignItems: "center" }}>
          ...
          {/* Right side: CTA card linking to lead magnet */}
          <AnimateOnScroll variant="fadeRight" delay={0.4} duration={0.9}>
            ...
            >
              ...
              <div style={{ marginBottom: 16 }}>
                ...
                <div style={{ display: "flex", alignItems: "center", border: "1px solid #e5e7eb", borderRadius: 10, background: "#f9fafb", padding: "12px 14px" }}>
                  ...
                  <span style={{ marginLeft: 10, fontSize: 13, color: "#9ca3af" }}>linkedin.com/in/jan-jansen</span>
                </div>
              </div>
              ...
              <div style={{ display: "block", width: "100%", padding: "14px", background: "linear-gradient(135deg, #8db600, #7aa300)", color: "white", border: "none", borderRadius: 12, fontSize: 15, fontWeight: 700, textAlign: "center", boxShadow: "0 4px 14px rgba(141,182,0,0.3)" }}>
